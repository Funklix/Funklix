(function (root, factory) {
  ...
  const german = {
    ...
    "Social Connections": "Social-Media-Verbindungen", "Connect accounts to publish approved content from Funklix": "Verbinde Konten, um freigegebene Inhalte aus Funklix zu veröffentlichen.",
