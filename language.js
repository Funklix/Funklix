(function (root, factory) {
  ...
  const german = {
    ...
    "Content Workspace": "Content-Arbeitsbereich", "Posting Plan": "Posting-Plan", "More filters": "Weitere Filter", "Needs review": "Prüfung nötig", "Unscheduled": "Ungeplant", "Content Library": "Inhaltsbibliothek", "Review Queue": "Prüfwarteschlange", "Calendar": "Kalender",
    ...
    "Tendra One is not currently receiving verified reach, engagement, conversion, revenue, spend, or attribution data for this campaign.": "Tendra One erhält derzeit keine verifizierten Daten zu Reichweite, Engagement, Conversions, Umsatz, Ausgaben oder Attribution für diese Kampagne.",
    ...
    "Canvas diagnostics evaluate the structure and content currently available in Tendra One. They do not measure audience response, media delivery, conversions, revenue, or business impact.": "Canvas-Diagnosen bewerten die aktuell in Tendra One vorhandene Struktur und die Inhalte. Sie messen keine Zielgruppenreaktionen, Medienausspielung, Conversions, Umsätze oder geschäftlichen Auswirkungen.",
    ...
    "Changes Tendra One controls and messages.": "Ändert die Bedienelemente und Meldungen in Tendra One.",
    ...
    "Interface language changes Tendra One controls and messages.": "Die Oberflächensprache ändert Tendra One-Steuerelemente und Meldungen.",
    ...
    "Social Connections": "Social-Media-Verbindungen", "Connect accounts to publish approved content from Tendra One": "Verbinde Konten, um freigegebene Inhalte aus Tendra One zu veröffentlichen.",
    "Not connected": "Nicht verbunden", "Setup required": "Einrichtung erforderlich", "Coming soon": "Demnächst verfügbar",
    "Internal planning continues to work independently of social connections.": "Die interne Planung funktioniert weiterhin unabhängig von Social-Media-Verbindungen.",
    "Authorize Tendra One to identify your personal profile and request permission to publish on your behalf.": "Autorisiere Tendra One, dein persönliches Profil zu identifizieren und die Berechtigung zum Veröffentlichen in deinem Namen anzufragen.", "Connect LinkedIn": "LinkedIn verbinden", "Reconnect": "Erneut verbinden", "Disconnect": "Trennen", "Personal profile": "Persönliches Profil", "Publishing permission available": "Veröffentlichungsberechtigung verfügbar", "Limited permissions": "Eingeschränkte Berechtigungen", "Reconnect required": "Erneute Verbindung erforderlich", "LinkedIn connected successfully.": "LinkedIn wurde erfolgreich verbunden.", "LinkedIn connected with limited permissions.": "LinkedIn wurde mit eingeschränkten Berechtigungen verbunden.", "Authorization was cancelled.": "Die Autorisierung wurde abgebrochen.", "Authorization expired.": "Die Autorisierung ist abgelaufen.", "Connection could not be completed.": "Die Verbindung konnte nicht abgeschlossen werden.", "LinkedIn was connected successfully.": "LinkedIn wurde erfolgreich verbunden.", "LinkedIn is connected. Publishing permission is not available yet.": "LinkedIn ist verbunden. Die Berechtigung zum Veröffentlichen ist noch nicht verfügbar.", "LinkedIn connection was cancelled.": "Die LinkedIn-Verbindung wurde abgebrochen.", "The connection request expired. Start the connection again.": "Die Verbindungsanfrage ist abgelaufen. Starte die Verbindung erneut.", "LinkedIn could not complete the authorization. Try connecting again.": "LinkedIn konnte die Autorisierung nicht abschließen. Verbinde das Konto erneut.", "LinkedIn setup needs attention before an account can be connected.": "Die LinkedIn-Einrichtung muss überprüft werden, bevor ein Konto verbunden werden kann.", "The account was authorized, but Tendra One could not save the connection.": "Das Konto wurde autorisiert, aber Tendra One konnte die Verbindung nicht speichern.", "LinkedIn authorized the request, but the profile identity could not be verified.": "LinkedIn hat die Anfrage autorisiert, aber die Profilidentität konnte nicht bestätigt werden.", "LinkedIn did not grant the required profile permission. Connect again and approve profile access.": "LinkedIn hat den erforderlichen Profilzugriff nicht gewährt. Verbinde das Konto erneut und erlaube den Profilzugriff.", "LinkedIn could not complete the connection. Try connecting again.": "LinkedIn konnte die Verbindung nicht abschließen. Verbinde das Konto erneut.", "Copy diagnostics": "Diagnose kopieren", "Approval saved. Verifying the current version…": "Freigabe gespeichert. Die aktuelle Version wird geprüft…", "The saved approval does not match the current publishable version.": "Die gespeicherte Freigabe stimmt nicht mit der aktuell veröffentlichbaren Version überein.",
    "Temporarily unavailable": "Vorübergehend nicht verfügbar", "Needs attention": "Überprüfung erforderlich", "Retry": "Erneut versuchen", "Retrying…": "Erneuter Versuch…", "Refreshing LinkedIn connection status…": "LinkedIn-Verbindungsstatus wird aktualisiert…", "LinkedIn connection storage is still unavailable. Please try again shortly.": "Der Speicher für LinkedIn-Verbindungen ist weiterhin nicht verfügbar. Bitte versuche es gleich erneut.", "The request did not complete. Check your connection and try again.": "Die Anfrage wurde nicht abgeschlossen. Prüfe deine Verbindung und versuche es erneut.", "The server returned an unreadable response. Please try again.": "Der Server hat eine nicht lesbare Antwort zurückgegeben. Bitte versuche es erneut.", "The connection status response was invalid. Please try again.": "Die Antwort zum Verbindungsstatus war ungültig. Bitte versuche es erneut.", "Please sign in again to refresh LinkedIn connection status.": "Bitte melde dich erneut an, um den LinkedIn-Verbindungsstatus zu aktualisieren.", "Current LinkedIn connection health could not be refreshed.": "Der aktuelle Zustand der LinkedIn-Verbindung konnte nicht aktualisiert werden.",
    "Authorize Tendra One to identify your personal profile.": "Autorisiere Tendra One, dein persönliches Profil zu identifizieren.", "LinkedIn server configuration needs administrator attention.": "Die LinkedIn-Serverkonfiguration muss administrativ überprüft werden.", "LinkedIn connection storage is temporarily unavailable.": "Der LinkedIn-Verbindungsspeicher ist vorübergehend nicht verfügbar.", "LinkedIn is disconnected. You can connect it again.": "LinkedIn ist getrennt. Du kannst die Verbindung erneut herstellen.", "Reconnect LinkedIn to restore the authorization.": "Verbinde LinkedIn erneut, um die Autorisierung wiederherzustellen.",
    "Disconnect LinkedIn?": "LinkedIn trennen?", "Disconnect LinkedIn": "LinkedIn trennen", "Tendra One will remove its stored LinkedIn authorization. Existing Boards and internal plans remain unchanged, and you can reconnect later.": "Tendra One entfernt die gespeicherte LinkedIn-Autorisierung. Bestehende Boards und interne Pläne bleiben unverändert, und du kannst die Verbindung später wiederherstellen.", "LinkedIn disconnected.": "LinkedIn wurde getrennt.", "LinkedIn could not be disconnected. Try again.": "LinkedIn konnte nicht getrennt werden. Versuche es erneut.", "Token expires": "Token läuft ab",
    ...
    "Drop a thought, question, or wild idea…": "Gedanke, Frage oder wilde Idee …", "Post-it message": "Post-it-Nachricht",
    "Reply": "Antworten", "Write a reply…": "Antwort schreiben …", "Reply message": "Antwortnachricht", "Send reply": "Antwort senden",
    ...
    "{count} unresolved comments. The complete comment workflow remains available on the Canvas.": "{count} ungelöste Kommentare. Der vollständige Kommentarablauf bleibt im Canvas verfügbar.",
    "AI Review details and actions remain available on the Canvas.": "Details und Aktionen der KI-Prüfung bleiben im Canvas verfügbar.",
    "Open AI Review in Inspector": "KI-Prüfung im Inspector öffnen", "Platform Preview": "Plattformvorschau", "Caption": "Bildunterschrift", "Social Caption": "Social-Media-Bildunterschrift",
    ...
    "Draft": "Entwurf", "In Review": "In Prüfung", "Needs Changes": "Änderungen erforderlich", "Changes requested": "Änderungen erforderlich", "Approved": "Freigegeben", "Published": "Veröffentlicht", "Submit for review": "Zur Prüfung einreichen", "Request changes": "Änderungen anfordern", "Reopen as Draft": "Als Entwurf erneut öffnen", "Reopen as draft": "Als Entwurf erneut öffnen", "Reopen for review": "Erneut prüfen", "This content has changed since approval. Approve the current version before publishing.": "Dieser Inhalt wurde seit der Freigabe verändert. Gib die aktuelle Version vor der Veröffentlichung erneut frei.",
  ...
  Object.assign(german, {
    ...
    "Add emoji to Post-it": "Emoji zum Post-it hinzufügen", "Add emoji to reply": "Emoji zur Antwort hinzufügen", "Emoji picker": "Emoji-Auswahl",
    "Reactions": "Reaktionen", "Ideas": "Ideen", "Progress": "Fortschritt", "Celebration": "Feiern",
    "Grinning face": "Grinsendes Gesicht", "Smiling face": "Lächelndes Gesicht", "Warm smile": "Herzliches Lächeln", "Tears of joy": "Freudentränen", "Thinking face": "Nachdenkliches Gesicht", "Eyes": "Augen", "Thumbs up": "Daumen hoch", "Thumbs down": "Daumen runter", "Red heart": "Rotes Herz",
    "Sparkles": "Funkeln", "Light bulb": "Glühbirne", "Question mark": "Fragezeichen", "Speech bubble": "Sprechblase", "Pushpin": "Reißzwecke", "Brain": "Gehirn", "Artist palette": "Farbpalette", "Memo": "Notiz", "Magnifying glass": "Lupe",
    "Bullseye": "Zielscheibe", "Rocket": "Rakete", "Check mark": "Häkchen", "Warning": "Warnung", "Chart increasing": "Steigendes Diagramm", "Strong arm": "Starker Arm", "Handshake": "Handschlag", "Hourglass": "Sanduhr", "Tools": "Werkzeuge",
    "Raised hands": "Erhobene Hände", "Clapping hands": "Klatschende Hände", "Fire": "Feuer", "Partying face": "Feierndes Gesicht", "Party popper": "Konfettikanone", "Trophy": "Pokal", "Star": "Stern", "Purple heart": "Lila Herz", "Glowing star": "Leuchtender Stern",
    ...
    "Delete Workspace Brand": "Workspace-Brand löschen", "Permanently delete Brand": "Brand dauerhaft löschen", "Type the exact Brand name to confirm": "Gib zur Bestätigung den exakten Brand-Namen ein", "Delete {name}": "{name} löschen", "Delete the Workspace/Brand “{name}”? This cannot be undone.": "Workspace/Brand „{name}“ löschen? Dies kann nicht rückgängig gemacht werden.", "The Canonical Brand, its Brand Core, and its memberships will be permanently deleted. Boards, Board content, nodes, approvals, publications, social connections, and user accounts will remain available. Board associations to this Brand will be cleared.": "Die kanonische Brand, ihr Brand Core und ihre Mitgliedschaften werden dauerhaft gelöscht. Boards, Board-Inhalte, Nodes, Freigaben, Veröffentlichungen, Social Connections und Benutzerkonten bleiben verfügbar. Board-Verknüpfungen zu dieser Brand werden entfernt.", "Enter the exact Brand name to continue.": "Gib den exakten Brand-Namen ein, um fortzufahren.", "Deleting Brand…": "Brand wird gelöscht…", "The Brand could not be deleted. It remains available; try again.": "Die Brand konnte nicht gelöscht werden. Sie bleibt verfügbar; versuche es erneut.", "Workspace/Brand “{name}” was deleted. Boards remain available.": "Workspace/Brand „{name}“ wurde gelöscht. Boards bleiben verfügbar."
  });
  ...
  Object.assign(german, {"Facebook":"Facebook","Facebook Page":"Facebook-Seite","Select Facebook Page":"Facebook-Seite auswählen","Select a Facebook Page to publish":"Facebook-Seite zum Veröffentlichen auswählen","Connect Facebook to publish":"Facebook verbinden, um zu veröffentlichen","Facebook content requires approval":"Facebook-Inhalte müssen freigegeben sein","Unsupported Facebook content":"Nicht unterstützter Facebook-Inhalt","Facebook publication unavailable":"Facebook-Veröffentlichung nicht verfügbar","Publishing to Facebook":"Wird auf Facebook veröffentlicht","Published to Facebook":"Auf Facebook veröffentlicht","Connect Facebook":"Facebook verbinden","Facebook Page":"Facebook-Seite","Select Page":"Seite auswählen","Connected Page":"Verbundene Seite","Connected":"Verbunden","Saving Facebook Page…":"Facebook-Seite wird gespeichert…","Facebook Page saved.":"Facebook-Seite gespeichert.","Facebook Page could not be saved. Try again.":"Die Facebook-Seite konnte nicht gespeichert werden. Bitte erneut versuchen.","No eligible Pages found":"Keine berechtigten Seiten gefunden","Missing publishing permission":"Veröffentlichungsberechtigung fehlt","Permission expired":"Berechtigung abgelaufen","Publish to Facebook":"Auf Facebook veröffentlichen","Publishing":"Wird veröffentlicht","Published":"Veröffentlicht","Open on Facebook":"Auf Facebook öffnen","Unsupported Facebook format":"Nicht unterstütztes Facebook-Format","Facebook is temporarily unavailable.":"Facebook ist vorübergehend nicht verfügbar.","Facebook could not complete the connection.":"Die Facebook-Verbindung konnte nicht abgeschlossen werden.","Facebook could not be disconnected.":"Facebook konnte nicht getrennt werden.","Facebook disconnected.":"Facebook wurde getrennt.","Facebook connected.":"Facebook wurde verbunden.","Connection cancelled.":"Verbindung abgebrochen.","Facebook connection failed.":"Facebook-Verbindung fehlgeschlagen.","Facebook connection expired. Please try again.":"Die Facebook-Verbindung ist abgelaufen. Bitte erneut versuchen.","Your session could not be verified. Please sign in and try again.":"Ihre Sitzung konnte nicht bestätigt werden. Bitte melden Sie sich erneut an.","Facebook could not complete authorization.":"Facebook konnte die Autorisierung nicht abschließen.","Facebook is missing a required Page permission.":"Facebook fehlt eine erforderliche Seitenberechtigung.","Facebook account details could not be loaded.":"Facebook-Kontodaten konnten nicht geladen werden.","Facebook Pages could not be loaded.":"Facebook-Seiten konnten nicht geladen werden.","No eligible Facebook Page was found.":"Es wurde keine berechtigte Facebook-Seite gefunden.","Facebook credentials could not be secured.":"Facebook-Zugangsdaten konnten nicht sicher gespeichert werden.","The Facebook account could not be saved.":"Das Facebook-Konto konnte nicht gespeichert werden.","The Facebook Page could not be saved.":"Die Facebook-Seite konnte nicht gespeichert werden.","Support reference":"Support-Referenz"});
