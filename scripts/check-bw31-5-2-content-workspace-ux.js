...
w.calendarState.mode='calendar';w.calendarState.view='list';w.render(host,context);assert.match(host.innerHTML,/content-calendar-list/);assert.match(host.innerHTML,/Unscheduled backlog/);assert.match(host.innerHTML,/Eligible/);assert.match(host.innerHTML,/no provider publishing/);
