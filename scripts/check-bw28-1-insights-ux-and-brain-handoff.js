...
has(render, ["Executive health overview", "Campaign journey coverage", "Opportunities", "Canvas Diagnostics", "Measured performance", "Data and Methodology", "Based on the structure and content of your current Canvas.", "insights-context"], "information hierarchy");
...
has(render, ["Current Canvas", "Current Board", "sourceState", "snapshot?.analyzedAt", "Diagnostic methods", "Assumptions", "Limitations"], "full methodology provenance");
// Explicit, accessible funnel mapping and deterministic qualitative thresholds.
has(render, ["funnelStages.forEach", "snapshot.analysis.funnel.coveredStages", 'present?"✓":"!"', '"Covered"', '"Missing content"', "insights-campaign-journey"], "campaign journey");
...
has(render, ["Object.entries(a.platformDistribution.counts)", "No supported channel content is present yet.", "insights-channel-row"], "channel counts");
has(render, ["How this is calculated", "Funnel-stage mapping", "CTA variation check"], "secondary methods");
...
has(css, ["insights-campaign-journey", "insights-channel-row", "min-height:44px", 'html[data-theme="dark"]', "@media (max-width:760px)", "overflow-wrap:anywhere"], "responsive themes and accessibility");
