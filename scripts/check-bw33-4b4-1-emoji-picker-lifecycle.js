...
vm.runInContext([
  ...
  "this.getActive=()=>activePostitEmojiPicker;this.forceClose=closePostitEmojiPicker;"
].join("\n"), context);
...
assert(render.includes("closePostitEmojiPicker()") && render.includes("note.resolved ? null") && render.includes('createPostitEmojiTrigger(replyInput, "reply")'));
