...
for (const text of ["Measured Performance","No analytics data connected","Canvas Diagnostics","Data status: Unavailable","Funklix is not currently receiving verified reach, engagement, conversion, revenue, spend, or attribution data for this campaign."]) assert(renderer.includes(text), `missing honest Insights copy: ${text}`);
