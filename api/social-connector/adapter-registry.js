...
const OPERATIONS=Object.freeze(['getAuthorizationRequest','exchangeAuthorizationCode','refreshCredentials','revokeConnection','discoverAccount','discoverDestinations','getCapabilities','validateContent','publish','linkedin_text_publish_v1','getPublicationStatus','reconcileUnknownOutcome','getPost','getPerformance']);
