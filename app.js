...
function renderInsightsSurface() {
  ...
  const root = make("div", "insights-boundary"); el.insightsCards.textContent = ""; el.insightsCards.appendChild(root);
